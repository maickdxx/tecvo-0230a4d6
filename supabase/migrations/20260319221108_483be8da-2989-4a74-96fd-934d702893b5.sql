...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'conversionCommercial', CASE WHEN c.attended_total > 0 THEN ROUND((c.scheduled_total::numeric / c.attended_total) * 100, 1)::numeric ELSE 0 END,
    'conversionOperational', CASE WHEN c.scheduled_total > 0 THEN ROUND((c.converted::numeric / c.scheduled_total) * 100, 1)::numeric ELSE 0 END,
    'conversionTotal', CASE WHEN c.total > 0 THEN ROUND((c.converted::numeric / c.total) * 100, 1)::numeric ELSE 0 END,
