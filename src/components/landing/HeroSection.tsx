          ...
          <div className="max-w-xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8 animate-fade-in">
              ...
              <strong className="text-foreground font-semibold">
                O Tecvo coloca tudo no lugar — serviços, clientes, financeiro e WhatsApp — e ainda tem uma secretária IA que te ajuda a organizar tudo pelo WhatsApp.
              </strong>
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8 animate-fade-in">
              <Button
                ...
                onClick={() => analytics.track("create_account_click", null, null, { location: "hero", page_section: "hero", button_label: cta, interaction_type: "click" })}
              >
                <Link to="/cadastro">
