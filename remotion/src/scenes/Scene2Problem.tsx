  ...
  return (
    <AbsoluteFill style={{ justifyContent: "center", alignItems: "center", padding: 60 }}>
      <div style={{ textAlign: "center", marginBottom: 60 }}>
        <div style={{ fontFamily: "sans-serif", fontSize: 26, fontWeight: 600, color: "#EF4444", opacity: interpolate(titleSpring, [0, 1], [0, 1]), marginBottom: 20, letterSpacing: 3, textTransform: "uppercase" }}>
          ⚠️ O problema
        </div>
        <h2 style={{
          fontFamily: "sans-serif", fontSize: 62, fontWeight: 800, color: "#E8EAF0", lineHeight: 1.2,
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20, width: "100%" }}>
        {problems.map((p, i) => {
          ...
          return (
            <div key={i} style={{
              display: "flex", alignItems: "center", gap: 20, padding: "24px 30px", borderRadius: 18,
              ...
              <span style={{ fontFamily: "sans-serif", fontSize: 30, fontWeight: 600, color: "#E8EAF0" }}>{p.text}</span>
            </div>
          );
        })}
      </div>
